    ...
    <AnimatePresence>
      ...
      {show ? (
        <motion.div
          ...
          className="fixed inset-0 backdrop-blur-xs bg-dark/50 z-50 dark:bg-light/20 grid place-items-center  px-20 gap-10"
        >
          <div className="flex items-center justify-center gap-10 w-full">
            ...
            >
              <div className="w-full max-w-[700px] flex flex-col items-start gap-6">
                ...
                >
                  I appreciate you taking the time to explore my work. I&apos;m
                  always open to new opportunities, collaborations, or simply a
                  good conversation about building great software. Feel free to
                  reach out — I’d love to connect and see how we can work
