      ...
      >
        {!loaded && (
          <img
            ...
            alt="loading"
            className="absolute inset-0 w-full bg-light h-full object-cover animate-pulse"
          />
        )}
        <img
          ...
          className={`w-full h-full object-cover bg-light transition duration-300 ${
            hover ? "scale-105" : ""
          }`}
        />

        <div
          className={`absolute inset-0 bg-slate-900/90 text-white flex flex-col justify-center items-center opacity-0 transition-opacity duration-300 space-y-2 lg:space-y-4 px-6 py-2 ${
            hover ? "opacity-100!" : ""
          }`}
        >
          <h4
            className={`font-anton text-center text-lg lg:text-xl mb-2 transition-transform translate-y-[600%] ${
              hover ? "translate-y-0!" : ""
            }`}
          >
            {title}
          ...
          <p
            className={`capitalize text-gray-300 px-4 text-sm lg:text-base text-center opacity-0 transition-opacity duration-1000 ${
              hover ? "opacity-100!" : ""
            }`}
          >
