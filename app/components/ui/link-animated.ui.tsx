...
export default function LinkAnimatedUI({
  ...
  return (
    <a
      href={href}
      className={`group relative cursor-pointer w-fit dark:text-dark-text ${
        className || ""
      }`}
